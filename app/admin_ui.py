...
def admin_backup_export_zip(
    ...
    """Download a full-state backup ZIP.

    Contains JSON dumps of every human-editable table plus a gzipped NDJSON
    audit stream.  Accounts are included but credential fields (password_hash,
    totp_secret, totp_recovery_hashes) are explicitly omitted so a leaked
