...
#
# Build:
#   docker build -t nks-wdc-catalog-api .
# Run:
...
# Create unprivileged runtime user — compromise of the app should not
# grant container root.
RUN groupadd --system --gid 1000 app \
    && useradd --system --uid 1000 --gid app --home /srv/app --shell /sbin/nologin app
